...
<html lang="en"><head>
    ...
    <link rel="stylesheet" type="text/css" href="muban/lib/bootstrap/css/bootstrap.css">
    <link rel="stylesheet" type="text/css" href="js/admin/bootstrapValidator.css">
    <link rel="stylesheet" href="muban/lib/font-awesome/css/font-awesome.css">

    <script src="muban/lib/jquery-1.11.1.min.js" type="text/javascript"></script>

    <script src="muban/lib/jQuery-Knob/js/jquery.knob.js" type="text/javascript"></script>
    ...
    <link rel="stylesheet" type="text/css" href="muban/stylesheets/theme.css">
    <link rel="stylesheet" type="text/css" href="muban/stylesheets/premium.css">
    @yield('extend_js')
</head>
        ...
        <ul id="main-menu" class="nav navbar-nav navbar-right">
            <li class="dropdown hidden-xs">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    <span class="glyphicon glyphicon-user padding-right-small" style="position:relative;top: 3px;"></span> {{ Session::get('admin_name') }}
...
<div class="sidebar-nav">
    <ul>
        ...
        <li><ul class="dashboard-menu nav nav-list collapse in">
                <li><a href="index.html"><span class="fa fa-caret-right"></span> 后台预览</a></li>
                <li ><a href="media.html"><span class="fa fa-caret-right"></span>管理员管理</a></li>
                <li ><a href="{{url('/users')}}"><span class="fa fa-caret-right"></span>用户列表</a></li>
                <li ><a href="{{url('/userProfile')}}"><span class="fa fa-caret-right"></span>用户详情</a></li>
                <li ><a href="calendar.html"><span class="fa fa-caret-right"></span> Calendar</a></li>
            </ul></li>

        <li data-popover="true" data-content="Items in this group require a <strong><a href='http://portnine.com/bootstrap-themes/aircraft' target='blank'>premium license</a><strong>." rel="popover" data-placement="right"><a href="#" data-target=".premium-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-fighter-jet"></i>权限管理<i class="fa fa-collapse"></i></a></li>
        <li><ul class="premium-menu nav nav-list collapse">
                <li class="visible-xs visible-sm"><a href="#">- Premium features require a license -</a></span>
                <li ><a href="premium-profile.html"><span class="fa fa-caret-right"></span>路由管理</a></li>
                <li ><a href="premium-blog.html"><span class="fa fa-caret-right"></span> 角色管理</a></li>
                <li ><a href="premium-blog-item.html"><span class="fa fa-caret-right"></span>权限绑定</a></li>
...
<script src="muban/lib/bootstrap/js/bootstrap.js"></script>
<script src="js/admin/bootstrapValidator.js"></script>
<script type="text/javascript">
    $("[rel=tooltip]").tooltip();
    $(function() {
